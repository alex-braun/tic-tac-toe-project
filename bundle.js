...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowAllGames = function onShowAllGames(event) {
	  event.preventDefault();
	  var userGames = gameUi.gameId;
	  viewUserGames = userGames;
	  gameApi.gamesShow(userGames).done(gameUi.showAllSuccess).fail(gameUi.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamesShow = function gamesShow() {
	  return $.ajax({
	    url: app.api + '/games/',
	    method: 'GET',
	    //data,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showAllSuccess = function showAllSuccess(userGames) {
	  if (userGames) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var playGame = function playGame() {
	  ...
	  var gridLocation = $(this).data('value');
	  var gridNumber = gameArray.indexOf(gridLocation);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "88ae0070eb4131f59e07fc4a67f9d6f3.jpg";
