...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowGame = function onShowGame(event) {
	  ...
	  console.log(data);
	  event.preventDefault();
	  gameApi.gameShow(data).done(gameUi.showGameSuccess).fail(gameUi.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamesShowAll = function gamesShowAll(data) {
	  return $.ajax({
	    url: app.api + '/games/',
	    method: 'GET',
	    data: data,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findGridLocation = function findGridLocation() {
	...
	module.exports = {
	  ...
	  findGridLocation: findGridLocation,
